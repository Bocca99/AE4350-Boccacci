...
env = snakeModel.SnakeEnvironment1(render_mode="human", model_path ="snake_final.xml")
...
actor.load_weights("actor_noise.h5")
critic.load_weights("critic_noise.h5")

targetActor = actor
targetCritic = critic

targetActor.load_weights("actor_noise.h5")
targetCritic.load_weights("critic_noise.h5")
